...
if (!CLOUDINARY_CLOUD_NAME) {
  console.error(
    "CONFIG ERROR: REACT_APP_CLOUDINARY_NAME environment variable is not set!"
  );
  toast.error(
...
export class DesignDownloader {
  ...
  static getProductTemplateUrl(productType, ProductColor) {
    ...
    if (!folder) {
      console.warn(
        `Template folder not defined for product type '${typeKey}'. Using default.`
      );
      return `${BASE_CLOUDINARY_URL}/t-shirts/t-shirt-${colorKey}-front.png`;
    }
  ...
  static async createProductMockup(
    ...
    try {
      ...
      // Define Printable Area based on product type
      let printableArea = {
        xRatio: 0.3,
        yRatio: 0.2,
        widthRatio: 0.4,
