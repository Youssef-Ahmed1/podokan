...
const checkTransparency = async (file) => {
  ...
  // Define the calculateDesignQualityScore callback first since it's used by handleDesignUpload
  ...
  // Scale Handler - Define before it's used in other handlers
          ...
          <div className="mb-8 space-y-4 bg-white p-4 rounded-lg shadow-md">
            ...
            <div className="mt-4 grid grid-cols-2 gap-4 text-sm">
              <div className="bg-gray-50 p-2 rounded">
                ...
                <span className="font-medium">{Math.round(designQualityScore.details.dpi)}</span>
              </div>
              <div className="bg-gray-50 p-2 rounded">
              ...
              <div className="bg-gray-50 p-2 rounded">
                ...
                <span className="font-medium">{designQualityScore.details.dimensions}</span>
              </div>
              <div className="bg-gray-50 p-2 rounded">
