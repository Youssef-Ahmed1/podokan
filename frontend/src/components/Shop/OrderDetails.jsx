              ...
              <div className="mb-6">
                  ...
                  {sellerItems.length === 0 ? ( // Should not happen if backend filter works, but good fallback
                      <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200 text-yellow-800 text-sm flex items-center gap-2">
                          <Info size={18} /> No items from your shop found in
                          this order record.
                      </div>
                  ) : (
                      ...
                      {sellerItems.length > 0 ? (
                          <div className="space-y-2">
                              ...
                              <p className="text-xs text-gray-400 mt-2">
                                  This is the total value of the items you
                                  supplied in this specific order.
                              </p>
                          </div>
                      ) : (
              ...
              {order.status === ORDER_STATUSES.PROCESSING_REFUND && (
                  <div className="mt-6 bg-white rounded-lg shadow p-5 border border-yellow-300">
                      <h3 className="text-lg font-semibold text-yellow-800 mb-3 flex items-center gap-2">
                          <AlertTriangle size={18} /> Action Required: Refund
                          Request
                      </h3>
                      <p className="text-sm text-gray-700 mb-4">
                          The customer has requested a refund for this order.
                          Please review and choose an action below.
                      </p>
                      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                          <Select
                              ...
                              sx={{
                                  ...
                                  height: "40px",
                                  flexGrow: 1,
                              }} // Allow dropdown to grow
                          >
                              {/* Placeholder option */}
                              <MenuItem
                                  value={ORDER_STATUSES.PROCESSING_REFUND}
                                  disabled
                              >
