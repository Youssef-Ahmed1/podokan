...
#### AUDIT-C05 — PayPal client ID hardcoded in the SPA bundle
...
#### AUDIT-C06 — JWT stored in `localStorage` while httpOnly cookies exist
...
#### AUDIT-C07 — Helmet Content-Security-Policy disabled
...
#### AUDIT-M03 — Duplicate async route wrappers
...
#### AUDIT-M10 — Multer allows 100MB uploads
...
#### AUDIT-M11 — `express.json` / `urlencoded` limit 50mb
